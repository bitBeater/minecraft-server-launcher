...
import { progress } from 'npm:cli@1.0.1';
import { log } from 'npm:iggs-utils@1.2.16';
import { maxSatisfying, valid } from 'npm:semver@7.5.4';
import { Packages } from './types/packages.js';
import { VersionManifestV2 } from './types/version_manifest_v2.js';
...
const installedServerVersions: string[] = Deno.readDirSync(SERVER_INSTALLATION_DIR).filter(i => valid(i));
