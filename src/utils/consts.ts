...
import { getOsAppInstallPath } from 'utils/fs.ts';
...
export const DEFAULT_SERVER_PROPERTIES_PATH = resolve(ASSETS_DIR, SERVER_PROPERTIES_FILE_NAME);
const SERVER_INSTALLATION_DIR = resolve(getOsAppInstallPath(), 'alexrr2iggs', 'minecraft_server');
